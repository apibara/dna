...
use apibara_sink_common::{SinkErrorResultExt, SinkOptions};
use clap::Args;
...
impl SinkParquetOptions {
    pub fn to_parquet_configuration(self) -> Result<SinkParquetConfiguration, SinkError> {
        let output_dir = self
            .output_dir
            .runtime_error("missing output directory")?
            .into();
