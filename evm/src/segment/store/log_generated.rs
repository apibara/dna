...
impl<'a> Log<'a> {
  ...
  pub fn topics(&self) -> Option<flatbuffers::Vector<'a, B256>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, B256>>>(Log::VT_TOPICS, None)}
  }
  #[inline]
  pub fn data(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Log::VT_DATA, None)}
  }
  #[inline]
  ...
  pub fn transaction_index(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Log::VT_TRANSACTION_INDEX, Some(0)).unwrap()}
  }
  #[inline]
...
impl flatbuffers::Verifiable for Log<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, B256>>>("topics", Self::VT_TOPICS, false)?
...
impl<'a: 'b, 'b> LogBuilder<'a, 'b> {
  ...
  pub fn add_topics(&mut self, topics: flatbuffers::WIPOffset<flatbuffers::Vector<'b , B256>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Log::VT_TOPICS, topics);
  }
  #[inline]
  pub fn add_data(&mut self, data: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Log::VT_DATA, data);
  }
  #[inline]
  ...
  pub fn add_transaction_index(&mut self, transaction_index: u64) {
    self.fbb_.push_slot::<u64>(Log::VT_TRANSACTION_INDEX, transaction_index, 0);
  }
  #[inline]
  pub fn add_transaction_hash(&mut self, transaction_hash: &B256) {
    self.fbb_.push_slot_always::<&B256>(Log::VT_TRANSACTION_HASH, transaction_hash);
  }
  #[inline]
