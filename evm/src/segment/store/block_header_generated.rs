...
impl<'a> BlockHeader<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.parent_beacon_block_root { builder.add_parent_beacon_block_root(x); }
    if let Some(x) = args.withdrawals { builder.add_withdrawals(x); }
    if let Some(x) = args.size_ { builder.add_size_(x); }
    if let Some(x) = args.uncles { builder.add_uncles(x); }
    if let Some(x) = args.total_difficulty { builder.add_total_difficulty(x); }
    if let Some(x) = args.withdrawals_root { builder.add_withdrawals_root(x); }
    if let Some(x) = args.base_fee_per_gas { builder.add_base_fee_per_gas(x); }
    if let Some(x) = args.mix_hash { builder.add_mix_hash(x); }
    if let Some(x) = args.extra_data { builder.add_extra_data(x); }
    if let Some(x) = args.gas_used { builder.add_gas_used(x); }
    if let Some(x) = args.gas_limit { builder.add_gas_limit(x); }
    if let Some(x) = args.difficulty { builder.add_difficulty(x); }
    if let Some(x) = args.logs_bloom { builder.add_logs_bloom(x); }
    if let Some(x) = args.receipts_root { builder.add_receipts_root(x); }
    if let Some(x) = args.transactions_root { builder.add_transactions_root(x); }
    if let Some(x) = args.state_root { builder.add_state_root(x); }
    if let Some(x) = args.miner { builder.add_miner(x); }
  ...
  pub fn number(&self) -> u64 {
    ...
    unsafe { self._tab.get::<u64>(BlockHeader::VT_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  ...
  pub fn transactions_root(&self) -> Option<&'a B256> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<B256>(BlockHeader::VT_TRANSACTIONS_ROOT, None)}
  }
  #[inline]
  ...
  pub fn extra_data(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(BlockHeader::VT_EXTRA_DATA, None)}
  }
  #[inline]
  ...
  pub fn nonce(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(BlockHeader::VT_NONCE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn base_fee_per_gas(&self) -> Option<&'a U256> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<U256>(BlockHeader::VT_BASE_FEE_PER_GAS, None)}
  }
  #[inline]
  pub fn withdrawals_root(&self) -> Option<&'a B256> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<B256>(BlockHeader::VT_WITHDRAWALS_ROOT, None)}
  }
  #[inline]
  pub fn total_difficulty(&self) -> Option<&'a U256> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<U256>(BlockHeader::VT_TOTAL_DIFFICULTY, None)}
  }
  #[inline]
  pub fn uncles(&self) -> Option<flatbuffers::Vector<'a, B256>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, B256>>>(BlockHeader::VT_UNCLES, None)}
  }
  #[inline]
  ...
  #[inline]
  pub fn withdrawals(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Withdrawal<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Withdrawal>>>>(BlockHeader::VT_WITHDRAWALS, None)}
  }
  #[inline]
  pub fn blob_gas_used(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(BlockHeader::VT_BLOB_GAS_USED, Some(0)).unwrap()}
  }
  #[inline]
  pub fn excess_blob_gas(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(BlockHeader::VT_EXCESS_BLOB_GAS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn parent_beacon_block_root(&self) -> Option<&'a B256> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<B256>(BlockHeader::VT_PARENT_BEACON_BLOCK_ROOT, None)}
  }
}
...
impl flatbuffers::Verifiable for BlockHeader<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, B256>>>("uncles", Self::VT_UNCLES, false)?
     .visit_field::<U256>("size_", Self::VT_SIZE_, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Withdrawal>>>>("withdrawals", Self::VT_WITHDRAWALS, false)?
     .visit_field::<u64>("blob_gas_used", Self::VT_BLOB_GAS_USED, false)?
     .visit_field::<u64>("excess_blob_gas", Self::VT_EXCESS_BLOB_GAS, false)?
     .visit_field::<B256>("parent_beacon_block_root", Self::VT_PARENT_BEACON_BLOCK_ROOT, false)?
     .finish();
    Ok(())
  }
}
pub struct BlockHeaderArgs<'a> {
    ...
    pub withdrawals: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Withdrawal<'a>>>>>,
...
impl<'a: 'b, 'b> BlockHeaderBuilder<'a, 'b> {
  ...
  pub fn add_number(&mut self, number: u64) {
    self.fbb_.push_slot::<u64>(BlockHeader::VT_NUMBER, number, 0);
  }
  #[inline]
  pub fn add_hash(&mut self, hash: &B256) {
    self.fbb_.push_slot_always::<&B256>(BlockHeader::VT_HASH, hash);
  }
  #[inline]
  pub fn add_parent_hash(&mut self, parent_hash: &B256) {
    self.fbb_.push_slot_always::<&B256>(BlockHeader::VT_PARENT_HASH, parent_hash);
  }
  #[inline]
  pub fn add_uncles_hash(&mut self, uncles_hash: &B256) {
    self.fbb_.push_slot_always::<&B256>(BlockHeader::VT_UNCLES_HASH, uncles_hash);
  }
  #[inline]
  pub fn add_miner(&mut self, miner: &Address) {
    self.fbb_.push_slot_always::<&Address>(BlockHeader::VT_MINER, miner);
  }
  #[inline]
  pub fn add_state_root(&mut self, state_root: &B256) {
    self.fbb_.push_slot_always::<&B256>(BlockHeader::VT_STATE_ROOT, state_root);
  }
  #[inline]
  pub fn add_transactions_root(&mut self, transactions_root: &B256) {
    self.fbb_.push_slot_always::<&B256>(BlockHeader::VT_TRANSACTIONS_ROOT, transactions_root);
  }
  #[inline]
  pub fn add_receipts_root(&mut self, receipts_root: &B256) {
    self.fbb_.push_slot_always::<&B256>(BlockHeader::VT_RECEIPTS_ROOT, receipts_root);
  }
  #[inline]
  pub fn add_logs_bloom(&mut self, logs_bloom: &Bloom) {
    self.fbb_.push_slot_always::<&Bloom>(BlockHeader::VT_LOGS_BLOOM, logs_bloom);
  }
  #[inline]
  pub fn add_difficulty(&mut self, difficulty: &U256) {
    self.fbb_.push_slot_always::<&U256>(BlockHeader::VT_DIFFICULTY, difficulty);
  }
  #[inline]
  pub fn add_gas_limit(&mut self, gas_limit: &U256) {
    self.fbb_.push_slot_always::<&U256>(BlockHeader::VT_GAS_LIMIT, gas_limit);
  }
  #[inline]
  pub fn add_gas_used(&mut self, gas_used: &U256) {
    self.fbb_.push_slot_always::<&U256>(BlockHeader::VT_GAS_USED, gas_used);
  }
  #[inline]
  ...
  pub fn add_extra_data(&mut self, extra_data: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(BlockHeader::VT_EXTRA_DATA, extra_data);
  }
  #[inline]
  pub fn add_mix_hash(&mut self, mix_hash: &B256) {
    self.fbb_.push_slot_always::<&B256>(BlockHeader::VT_MIX_HASH, mix_hash);
  }
  #[inline]
  ...
  pub fn add_base_fee_per_gas(&mut self, base_fee_per_gas: &U256) {
    self.fbb_.push_slot_always::<&U256>(BlockHeader::VT_BASE_FEE_PER_GAS, base_fee_per_gas);
  }
  #[inline]
  pub fn add_withdrawals_root(&mut self, withdrawals_root: &B256) {
    self.fbb_.push_slot_always::<&B256>(BlockHeader::VT_WITHDRAWALS_ROOT, withdrawals_root);
  }
  #[inline]
  pub fn add_total_difficulty(&mut self, total_difficulty: &U256) {
    self.fbb_.push_slot_always::<&U256>(BlockHeader::VT_TOTAL_DIFFICULTY, total_difficulty);
  }
  #[inline]
  pub fn add_uncles(&mut self, uncles: flatbuffers::WIPOffset<flatbuffers::Vector<'b , B256>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(BlockHeader::VT_UNCLES, uncles);
  }
  #[inline]
  pub fn add_size_(&mut self, size_: &U256) {
    self.fbb_.push_slot_always::<&U256>(BlockHeader::VT_SIZE_, size_);
  }
  #[inline]
  pub fn add_withdrawals(&mut self, withdrawals: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Withdrawal<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(BlockHeader::VT_WITHDRAWALS, withdrawals);
  }
  #[inline]
  pub fn add_blob_gas_used(&mut self, blob_gas_used: u64) {
    self.fbb_.push_slot::<u64>(BlockHeader::VT_BLOB_GAS_USED, blob_gas_used, 0);
  }
  #[inline]
  pub fn add_excess_blob_gas(&mut self, excess_blob_gas: u64) {
    self.fbb_.push_slot::<u64>(BlockHeader::VT_EXCESS_BLOB_GAS, excess_blob_gas, 0);
  }
  #[inline]
  pub fn add_parent_beacon_block_root(&mut self, parent_beacon_block_root: &B256) {
    self.fbb_.push_slot_always::<&B256>(BlockHeader::VT_PARENT_BEACON_BLOCK_ROOT, parent_beacon_block_root);
  }
  #[inline]
