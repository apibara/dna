...
impl<'a> Transaction<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.blob_versioned_hashes { builder.add_blob_versioned_hashes(x); }
    if let Some(x) = args.max_fee_per_blob_gas { builder.add_max_fee_per_blob_gas(x); }
    if let Some(x) = args.access_list { builder.add_access_list(x); }
    if let Some(x) = args.signature { builder.add_signature(x); }
    if let Some(x) = args.input { builder.add_input(x); }
    if let Some(x) = args.max_priority_fee_per_gas { builder.add_max_priority_fee_per_gas(x); }
    if let Some(x) = args.max_fee_per_gas { builder.add_max_fee_per_gas(x); }
    if let Some(x) = args.gas { builder.add_gas(x); }
  ...
  pub fn transaction_index(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Transaction::VT_TRANSACTION_INDEX, Some(0)).unwrap()}
  }
  #[inline]
  ...
  pub fn max_priority_fee_per_gas(&self) -> Option<&'a U128> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<U128>(Transaction::VT_MAX_PRIORITY_FEE_PER_GAS, None)}
  }
  #[inline]
  pub fn input(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Transaction::VT_INPUT, None)}
  }
  #[inline]
  pub fn signature(&self) -> Option<Signature<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Signature>>(Transaction::VT_SIGNATURE, None)}
  }
  #[inline]
  ...
  pub fn transaction_type(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Transaction::VT_TRANSACTION_TYPE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn max_fee_per_blob_gas(&self) -> Option<&'a U128> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<U128>(Transaction::VT_MAX_FEE_PER_BLOB_GAS, None)}
  }
  #[inline]
  pub fn blob_versioned_hashes(&self) -> Option<flatbuffers::Vector<'a, B256>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, B256>>>(Transaction::VT_BLOB_VERSIONED_HASHES, None)}
  }
}
...
impl flatbuffers::Verifiable for Transaction<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<U128>("max_priority_fee_per_gas", Self::VT_MAX_PRIORITY_FEE_PER_GAS, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, B256>>>("blob_versioned_hashes", Self::VT_BLOB_VERSIONED_HASHES, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> TransactionBuilder<'a, 'b> {
  ...
  pub fn add_hash(&mut self, hash: &B256) {
    self.fbb_.push_slot_always::<&B256>(Transaction::VT_HASH, hash);
  }
  #[inline]
  ...
  pub fn add_transaction_index(&mut self, transaction_index: u64) {
    self.fbb_.push_slot::<u64>(Transaction::VT_TRANSACTION_INDEX, transaction_index, 0);
  }
  #[inline]
  pub fn add_from(&mut self, from: &Address) {
    self.fbb_.push_slot_always::<&Address>(Transaction::VT_FROM, from);
  }
  #[inline]
  pub fn add_to(&mut self, to: &Address) {
    self.fbb_.push_slot_always::<&Address>(Transaction::VT_TO, to);
  }
  #[inline]
  pub fn add_value(&mut self, value: &U256) {
    self.fbb_.push_slot_always::<&U256>(Transaction::VT_VALUE, value);
  }
  #[inline]
  pub fn add_gas_price(&mut self, gas_price: &U128) {
    self.fbb_.push_slot_always::<&U128>(Transaction::VT_GAS_PRICE, gas_price);
  }
  #[inline]
  pub fn add_gas(&mut self, gas: &U256) {
    self.fbb_.push_slot_always::<&U256>(Transaction::VT_GAS, gas);
  }
  #[inline]
  pub fn add_max_fee_per_gas(&mut self, max_fee_per_gas: &U128) {
    self.fbb_.push_slot_always::<&U128>(Transaction::VT_MAX_FEE_PER_GAS, max_fee_per_gas);
  }
  #[inline]
  pub fn add_max_priority_fee_per_gas(&mut self, max_priority_fee_per_gas: &U128) {
    self.fbb_.push_slot_always::<&U128>(Transaction::VT_MAX_PRIORITY_FEE_PER_GAS, max_priority_fee_per_gas);
  }
  #[inline]
  pub fn add_input(&mut self, input: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Transaction::VT_INPUT, input);
  }
  #[inline]
  pub fn add_signature(&mut self, signature: flatbuffers::WIPOffset<Signature<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Signature>>(Transaction::VT_SIGNATURE, signature);
  }
  #[inline]
  ...
  pub fn add_transaction_type(&mut self, transaction_type: u64) {
    self.fbb_.push_slot::<u64>(Transaction::VT_TRANSACTION_TYPE, transaction_type, 0);
  }
  #[inline]
  pub fn add_max_fee_per_blob_gas(&mut self, max_fee_per_blob_gas: &U128) {
    self.fbb_.push_slot_always::<&U128>(Transaction::VT_MAX_FEE_PER_BLOB_GAS, max_fee_per_blob_gas);
  }
  #[inline]
  pub fn add_blob_versioned_hashes(&mut self, blob_versioned_hashes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , B256>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Transaction::VT_BLOB_VERSIONED_HASHES, blob_versioned_hashes);
  }
  #[inline]
