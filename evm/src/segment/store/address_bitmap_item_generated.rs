...
impl<'a> AddressBitmapItem<'a> {
  ...
  pub fn bitmap(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(AddressBitmapItem::VT_BITMAP, None)}
  }
}
...
impl<'a: 'b, 'b> AddressBitmapItemBuilder<'a, 'b> {
  ...
  pub fn add_key(&mut self, key: &Address) {
    self.fbb_.push_slot_always::<&Address>(AddressBitmapItem::VT_KEY, key);
  }
  #[inline]
  pub fn add_bitmap(&mut self, bitmap: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AddressBitmapItem::VT_BITMAP, bitmap);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> AddressBitmapItemBuilder<'a, 'b> {
