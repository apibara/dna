...
impl<'a> AccessListItem<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.storage_keys {
            builder.add_storage_keys(x);
        }
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, B256>>>(
                    AccessListItem::VT_STORAGE_KEYS,
                    None,
                )
        }
    }
...
impl<'a: 'b, 'b> AccessListItemBuilder<'a, 'b> {
    ...
    pub fn add_address(&mut self, address: &Address) {
        self.fbb_
            .push_slot_always::<&Address>(AccessListItem::VT_ADDRESS, address);
    }
    #[inline]
    pub fn add_storage_keys(
        &mut self,
        storage_keys: flatbuffers::WIPOffset<flatbuffers::Vector<'b, B256>>,
    ) {
