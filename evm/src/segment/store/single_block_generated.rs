...
impl<'a> SingleBlock<'a> {
  ...
  pub fn header(&self) -> Option<BlockHeader<'a>> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<BlockHeader>>(SingleBlock::VT_HEADER, None)}
  }
  #[inline]
  pub fn transactions(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Transaction<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Transaction>>>>(SingleBlock::VT_TRANSACTIONS, None)}
  }
  #[inline]
  pub fn receipts(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TransactionReceipt<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TransactionReceipt>>>>(SingleBlock::VT_RECEIPTS, None)}
  }
  #[inline]
  pub fn logs(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Log<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Log>>>>(SingleBlock::VT_LOGS, None)}
  }
}
...
impl flatbuffers::Verifiable for SingleBlock<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Transaction>>>>("transactions", Self::VT_TRANSACTIONS, false)?
...
impl<'a: 'b, 'b> SingleBlockBuilder<'a, 'b> {
  ...
  pub fn add_header(&mut self, header: flatbuffers::WIPOffset<BlockHeader<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<BlockHeader>>(SingleBlock::VT_HEADER, header);
  }
  #[inline]
  pub fn add_transactions(&mut self, transactions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Transaction<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SingleBlock::VT_TRANSACTIONS, transactions);
  }
  #[inline]
  pub fn add_receipts(&mut self, receipts: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<TransactionReceipt<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SingleBlock::VT_RECEIPTS, receipts);
  }
  #[inline]
  pub fn add_logs(&mut self, logs: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Log<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SingleBlock::VT_LOGS, logs);
  }
  #[inline]
