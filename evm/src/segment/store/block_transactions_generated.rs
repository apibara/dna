...
impl<'a> BlockTransactions<'a> {
  ...
  pub fn block_number(&self) -> u64 {
    ...
    unsafe { self._tab.get::<u64>(BlockTransactions::VT_BLOCK_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn transactions(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Transaction<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Transaction>>>>(BlockTransactions::VT_TRANSACTIONS, None)}
  }
}
...
impl<'a: 'b, 'b> BlockTransactionsBuilder<'a, 'b> {
  ...
  pub fn add_block_number(&mut self, block_number: u64) {
    self.fbb_.push_slot::<u64>(BlockTransactions::VT_BLOCK_NUMBER, block_number, 0);
  }
  #[inline]
