...
impl<'a> BlockHeader<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.starknet_version {
            builder.add_starknet_version(x);
        }
        if let Some(x) = args.l1_gas_price {
            builder.add_l1_gas_price(x);
        }
        if let Some(x) = args.sequencer_address {
            builder.add_sequencer_address(x);
        }
        if let Some(x) = args.new_root {
            builder.add_new_root(x);
        }
    ...
    pub fn block_hash(&self) -> Option<&'a FieldElement> {
        ...
        unsafe {
            self._tab
                .get::<FieldElement>(BlockHeader::VT_BLOCK_HASH, None)
        }
    }
    #[inline]
    pub fn parent_hash(&self) -> Option<&'a FieldElement> {
        ...
        unsafe {
            self._tab
                .get::<FieldElement>(BlockHeader::VT_PARENT_HASH, None)
        }
    }
    #[inline]
    pub fn block_number(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(BlockHeader::VT_BLOCK_NUMBER, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn new_root(&self) -> Option<&'a FieldElement> {
        ...
        unsafe {
            self._tab
                .get::<FieldElement>(BlockHeader::VT_NEW_ROOT, None)
        }
    }
    #[inline]
    ...
    pub fn sequencer_address(&self) -> Option<&'a FieldElement> {
        ...
        unsafe {
            self._tab
                .get::<FieldElement>(BlockHeader::VT_SEQUENCER_ADDRESS, None)
        }
    }
    #[inline]
    pub fn l1_gas_price(&self) -> Option<ResourcePrice<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<ResourcePrice>>(
                    BlockHeader::VT_L1_GAS_PRICE,
                    None,
                )
        }
    }
    ...
    pub fn starknet_version(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(BlockHeader::VT_STARKNET_VERSION, None)
        }
    }
}
...
impl flatbuffers::Verifiable for BlockHeader<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<ResourcePrice>>(
                "l1_gas_price",
                Self::VT_L1_GAS_PRICE,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "starknet_version",
                Self::VT_STARKNET_VERSION,
                false,
            )?
            .finish();
        Ok(())
...
impl<'a: 'b, 'b> BlockHeaderBuilder<'a, 'b> {
    ...
    pub fn add_block_hash(&mut self, block_hash: &FieldElement) {
        self.fbb_
            .push_slot_always::<&FieldElement>(BlockHeader::VT_BLOCK_HASH, block_hash);
    }
    #[inline]
    pub fn add_parent_hash(&mut self, parent_hash: &FieldElement) {
        self.fbb_
            .push_slot_always::<&FieldElement>(BlockHeader::VT_PARENT_HASH, parent_hash);
    }
    #[inline]
    pub fn add_block_number(&mut self, block_number: u64) {
        self.fbb_
            .push_slot::<u64>(BlockHeader::VT_BLOCK_NUMBER, block_number, 0);
    }
    #[inline]
    pub fn add_new_root(&mut self, new_root: &FieldElement) {
        self.fbb_
            .push_slot_always::<&FieldElement>(BlockHeader::VT_NEW_ROOT, new_root);
    }
    #[inline]
    ...
    pub fn add_sequencer_address(&mut self, sequencer_address: &FieldElement) {
        self.fbb_.push_slot_always::<&FieldElement>(
            BlockHeader::VT_SEQUENCER_ADDRESS,
            sequencer_address,
        );
    }
    #[inline]
    pub fn add_l1_gas_price(&mut self, l1_gas_price: flatbuffers::WIPOffset<ResourcePrice<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<ResourcePrice>>(
                BlockHeader::VT_L1_GAS_PRICE,
                l1_gas_price,
            );
    }
    ...
    pub fn add_starknet_version(&mut self, starknet_version: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            BlockHeader::VT_STARKNET_VERSION,
            starknet_version,
        );
    }
    #[inline]
