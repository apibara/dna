...
impl<'a> BlockEvents<'a> {
  ...
  pub fn block_number(&self) -> u64 {
    ...
    unsafe { self._tab.get::<u64>(BlockEvents::VT_BLOCK_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn events(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Event<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Event>>>>(BlockEvents::VT_EVENTS, None)}
  }
}
...
impl<'a: 'b, 'b> BlockEventsBuilder<'a, 'b> {
  ...
  pub fn add_block_number(&mut self, block_number: u64) {
    self.fbb_.push_slot::<u64>(BlockEvents::VT_BLOCK_NUMBER, block_number, 0);
  }
  #[inline]
  pub fn add_events(&mut self, events: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Event<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(BlockEvents::VT_EVENTS, events);
  }
  #[inline]
