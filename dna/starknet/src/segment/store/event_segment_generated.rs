...
impl<'a> EventSegment<'a> {
  ...
  pub fn first_block_number(&self) -> u64 {
    ...
    unsafe { self._tab.get::<u64>(EventSegment::VT_FIRST_BLOCK_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn blocks(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BlockEvents<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BlockEvents>>>>(EventSegment::VT_BLOCKS, None)}
  }
}
...
impl flatbuffers::Verifiable for EventSegment<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<BlockEvents>>>>("blocks", Self::VT_BLOCKS, false)?
     .finish();
    Ok(())
  }
}
pub struct EventSegmentArgs<'a> {
    ...
    pub blocks: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BlockEvents<'a>>>>>,
}
...
impl<'a: 'b, 'b> EventSegmentBuilder<'a, 'b> {
  ...
  pub fn add_first_block_number(&mut self, first_block_number: u64) {
    self.fbb_.push_slot::<u64>(EventSegment::VT_FIRST_BLOCK_NUMBER, first_block_number, 0);
  }
  #[inline]
  pub fn add_blocks(&mut self, blocks: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<BlockEvents<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(EventSegment::VT_BLOCKS, blocks);
  }
  #[inline]
